...
export const renderVideoPage = () => `
  ...
  <section class="section">
    <div class="video-cloud video-cloud-covers video-cloud-hover-focus">
      ${videoProjects
        .map(
          (item, index) => `
            <a class="video-bubble video-cover-card video-cover-card-refined ${item.status === 'coming-soon' ? 'is-muted' : ''}" href="/video/${item.slug}" data-link style="--bubble-index:${index}">
